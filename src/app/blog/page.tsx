...
const posts: BlogPost[] = [
    ...
    },
    {
        ...
        title: {
            tr: 'AI Virtual Staging ile Mülkünüzü %40 Daha Hızlı Satın',
            en: 'AI Virtual Staging: Sell Your Property 40% Faster',
            ru: 'AI виртуальный стейджинг: продайте на 40% быстрее',
            de: 'AI Virtual Staging: Verkaufen Sie 40% schneller',
            ar: 'التنظيم الافتراضي بالذكاء الاصطناعي: بع عقارك أسرع بنسبة 40%',
        },
        excerpt: {
            tr: 'Boş odalarınızı 30 saniyede mobilyalı görsellere dönüştürün. 20+ dekorasyon stili, mimar kalite kontrolü.',
            en: 'Transform empty rooms into furnished visuals in 30 seconds. 20+ design styles, architect quality control.',
            ru: 'Превратите пустые комнаты в меблированные за 30 секунд.',
            de: 'Verwandeln Sie leere Räume in 30 Sekunden in möblierte Bilder.',
            ar: 'حوّل الغرف الفارغة إلى صور مؤثثة في 30 ثانية.',
        },
        category: '🖼️ AI Tools',
        readTime: '6 min',
        date: '2026-02-24',
